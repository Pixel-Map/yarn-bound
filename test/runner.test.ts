...
import fs from 'fs';
import { CommandResult, OptionsResult, TextResult } from '../lib';
...
describe('Dialogue', () => {
  ...
  it('Can run through a single line', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNode';
        }),
      },
    };
    delete metadata.body;
    const value = run.next().value;
    expect(value).toEqual(new TextResult('This is a test line', [], metadata));
  ...
  it('Can run through two lines', () => {
    ...
    expect(value).toEqual(new TextResult('This is another test line', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can start at a different node', () => {
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult("This is Option2's test line", [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can run through a first option to another node', () => {
    ...
    value = run.next().value;
    expect(value).toEqual(new OptionsResult([{ text: 'First choice' }, { text: 'Second choice' }], metadata));

    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult("This is Option1's test line", [], metadata2));
  ...
  it('Can run through a second option to another node', () => {
    ...
    value.select(1);
    value = run.next().value;
    expect(value).toEqual(new TextResult("This is Option2's test line", [], metadata2));
  ...
  it('Includes node metadata with result', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNodeMetadata';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Includes hashtags with text results', () => {
    ...
    expect(value).toEqual(
      new TextResult('This is a test line', ['someHashtag', 'someOtherHashtag', 'lastHashtag'], metadata),
    );
    expect(run.next().done).toBe(true);
  });
  ...
  it('Ignores comments on option lines', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'NonNestedHashtag';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(
      new OptionsResult(
        [{ text: 'Option 1', hashtags: ['someHashtag', 'someOtherHashtag', 'lastHashtag'] }, { text: 'Option 2' }],
        metadata,
      ),
    );
    value.select(1);
    value = run.next().value;
    expect(value).toEqual(new TextResult('This is the second option', [], metadata));
  ...
  it('includes hashtags on conditional option lines', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'ConditionalHashtag';
        }),
      },
    };
    delete metadata.body;
    ...
    value.select(2);
    value = run.next().value;
    expect(value).toEqual(new TextResult('This is the third option', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('This is after both options', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('includes hashtags on command lines', () => {
    ...
    const metadata = {
      ...{
        ...commandAndFunctionYarnData.find((n) => {
          return n.title === 'BasicCommandsHashtag';
        }),
      },
    };
    delete metadata.body;
    ...
    let value = run.next().value;
    expect(value).toEqual(new CommandResult('command', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('text in between commands', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new CommandResult('command with "space"', ['someHashtag'], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('includes hashtags on lines only containing inline expression', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'SimpleInlineExpHashtag';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('1', ['someHashtag'], metadata));
  ...
  it('Ignores comments on their own line', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNodeWholeLineComment';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(new TextResult('This is a test line', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Hello', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Ignores comments on option lines', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'NonNestedComment';
        }),
      },
    };
    delete metadata.body;
    ...
    let value = run.next().value;
    expect(value).toEqual(new OptionsResult([{ text: 'Option 1' }, { text: 'Option 2' }], metadata));
    value.select(1);
    value = run.next().value;
    expect(value).toEqual(new TextResult('This is the second option', [], metadata));
  ...
  it('ignores comments on conditional option lines', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'ConditionalComment';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(
      new OptionsResult(
        [{ text: 'Option 1' }, { text: 'Option 2', isAvailable: false }, { text: 'Option 3' }],
        metadata,
      ),
    );
  ...
  it('ignores comments on command lines', () => {
    ...
    const metadata = {
      ...{
        ...commandAndFunctionYarnData.find((n) => {
          return n.title === 'BasicCommandsComment';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(new TextResult('text in between commands', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new CommandResult('command with "space"', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('ignores comments on lines only containing inline expression', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'SimpleInlineExpComment';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('1', [], metadata));
  ...
  it('Automatically goes to the jump node', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneJumpPassthrough';
        }),
      },
    };
    delete metadata.body;
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('First test line', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult("This is Option1's test line", [], metadata2));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Automatically goes through two jumps', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'TwoJumpPassthrough';
        }),
      },
    };
    delete metadata.body;
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('Real First test line', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('First test line', [], metadata2));
    value = run.next().value;
    expect(value).toEqual(new TextResult("This is Option1's test line", [], metadata3));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can run through nested shortcuts', () => {
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('text', [], metadata));

    value = run.next().value;
    expect(value).toEqual(new OptionsResult([{ text: 'shortcut1a' }, { text: 'shortcut2a' }], metadata));

    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult('Text1', [], metadata));

    value = run.next().value;
    expect(value).toEqual(
      new OptionsResult([{ text: 'nestedshortcut1' }, { text: 'nestedshortcut2' }], metadata),
    );

    value.select(1);
    value = run.next().value;
    expect(value).toEqual(new TextResult('NestedText2', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('more text', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can set a custom variable storage', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'Numeric';
        }),
      },
    };
    delete metadata.body;
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('Test Line', [], metadata));

    runner.setVariableStorage(new Map());
    expect(runner.variables.get('testvar')).toBe(undefined);

    value = run.next().value;
    expect(value).toEqual(new TextResult('Test Line After', [], metadata));
  ...
  it('Can evaluate a numeric assignment with an expression', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'NumericExpression';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can evaluate a numeric assignment with division expression', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'AssignmentWithDivision';
        }),
      },
    };
    delete metadata.body;
    ...
    value = run.next().value;
    expect(value).toEqual(new TextResult('Test Line2', [], metadata));
  ...
  it('Can evaluate a string assignment with an expression', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'StringExpression';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can evaluate a function boolean assignment', () => {
    ...
    runner.registerFunction('identity', (x) => {
      return x;
    });
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'AssignmentWithFunction';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can evaluate a boolean assignment with expression', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'BooleanExpression';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can evaluate an assignment from one variable to another via an expression', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'VariableExpression';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can evaluate an assignment from one variable to another via an expression with self reference', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'VariableExpression2';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can handle an if conditional', () => {
    ...
    const metadata = {
      ...{
        ...conditionalYarnData.find((n) => {
          return n.title === 'BasicIf';
        }),
      },
    };
    delete metadata.body;
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('Text before', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Inside if', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Inside if2', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Text after', [], metadata));
  ...
  it('Can handle an if else conditional', () => {
    ...
    expect(value).toEqual(new TextResult('Text before', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Inside else', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Text after', [], metadata));
  ...
  it('Can handle an if elseif conditional', () => {
    ...
    expect(value).toEqual(new TextResult('Text before', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Inside elseif', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Text after', [], metadata));
  ...
  it('Can handle an if elseif else conditional', () => {
    ...
    const metadata = {
      ...{
        ...conditionalYarnData.find((n) => {
          return n.title === 'BasicIfElseIfElse';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Halts when given the <<stop>> command', () => {
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('First line', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Ignores content after jumps when going through multiple options', () => {
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('Prompt1', [], metadata));
    value = run.next().value;
    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult('Prompt2', [], metadata2));
    value = run.next().value;
    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult('First line', [], metadata3));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Returns commands with inline expressions to the user', () => {
    ...
    const metadata = {
      ...{
        ...commandAndFunctionYarnData.find((n) => {
          return n.title === 'ExpressionArgumentCommand';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new CommandResult('command 1 5 apple 10', [], metadata));
    expect(run.next().done).toBe(true);
  });

  it('handles a simple function call with numbers', () => {
    runner.registerFunction('addOne', (num) => {
      return num + 1;
    });
    runner.load(commandAndFunctionYarnData);
    ...
    let value = run.next().value;
    expect(value).toEqual(new TextResult('4', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('5', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Evaluates a function and uses it in a conditional', () => {
    ...
    const metadata = {
      ...{
        ...commandAndFunctionYarnData.find((n) => {
          return n.title === 'FunctionConditional';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(new TextResult('First line', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('This should show', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('After both', [], metadata));
  ...
  it('Should ignore text after a jump after an option', () => {
    ...
    const metadata = {
      ...{
        ...conditionalYarnData.find((n) => {
          return n.title === 'TextAfterJumpAfterOption';
        }),
      },
    };
    delete metadata.body;
    ...
    value = run.next().value;
    expect(value).toEqual(new OptionsResult([{ text: 'Give key' }], metadata));

    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult('You give the key to the troll.', [], metadata2));
  ...
  it('Should ignore text after a jump after a conditional option', () => {
    ...
    const metadata = {
      ...{
        ...conditionalYarnData.find((n) => {
          return n.title === 'ConditionalOption';
        }),
      },
    };
    delete metadata.body;
    ...
    value = run.next().value;
    expect(value).toEqual(new OptionsResult([{ text: 'Cond Option' }], metadata));

    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult('You reach the objective.', [], metadata2));
  ...
  it('Should ignore text after a jump after an option in a conditional block', () => {
    ...
    const metadata = {
      ...{
        ...conditionalYarnData.find((n) => {
          return n.title === 'OptionAfterOptionWithinConditional';
        }),
      },
    };
    delete metadata.body;
    ...
    value = run.next().value;
    expect(value).toEqual(new OptionsResult([{ text: 'Give key' }, { text: 'You keep the key.' }], metadata));
  ...
  it('Should move on after a first option with no follow-up is selected', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'EmptyFirstOption';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Should move on after a second option with no follow-up is selected', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'EmptySecondOption';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Should move on after a conditional option with no follow-up is selected', () => {
    ...
    const metadata = {
      ...{
        ...shortcutsYarnData.find((n) => {
          return n.title === 'EmptyConditional';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can handle a simple inline expression', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'SimpleInlineExp';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can handle sequential inline expressions', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'SequentialInlineExpressions';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('12', [], metadata));
  ...
  it('Can handle non-sequential inline expressions', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'NonSequentialInlineExpressions';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('1textbetween2', [], metadata));
  ...
  it('Can handle a simple inline expression in a sentence', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpSentence';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('This is a test.', [], metadata));
  ...
  it('Can handle an arithmetic inline expression', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpArithmetic';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('The results are 10 and 12 and 1.', [], metadata));
  ...
  it('Can handle an inline expression with a variable', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpVariable';
        }),
      },
    };
    delete metadata.body;
    const value = run.next().value;
    expect(value).toEqual(
      new TextResult('The results are -1 and true and true and true and true and true.', [], metadata),
    );
  ...
  it('Can handle an inline expression in an option', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'OptionInlineExpression';
        }),
      },
    };
    delete metadata.body;
    ...
    value = run.next().value;
    expect(value).toEqual(
      new OptionsResult([{ text: 'First test choice' }, { text: 'Second choice' }], metadata),
    );

    value.select(0);
    value = run.next().value;
    expect(value).toEqual(new TextResult("This is Option1's test text", [], metadata));
  ...
  it('Can handle an inline expression in a conditional option', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'ConditionalOptionInlineExpression';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can handle a simple inline expression whitespace in a sentence', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpAddSentence';
        }),
      },
    };
    delete metadata.body;
    ...
    const value = run.next().value;
    expect(value).toEqual(new TextResult('This is a 2 sentence.', [], metadata));
  ...
  it('Can handle an if arithmetic expression elseif conditional', () => {
    ...
    const metadata = {
      ...{
        ...conditionalYarnData.find((n) => {
          return n.title === 'ArithmeticExpressionConditional';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(new TextResult('Text after', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Final text', [], metadata));
  ...
  it('Can evaluate a numeric assignment with exponent expression', () => {
    ...
    const metadata = {
      ...{
        ...assignmentYarnData.find((n) => {
          return n.title === 'ExponentExpression';
        }),
      },
    };
    delete metadata.body;
  ...
  it('can handle a negated function call in a conditional', () => {
    runner.registerFunction('returnFalse', () => {
      return false;
    });
  ...
  it('Can handle inline expression containing function call', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpFunctionResult';
        }),
      },
    };
    delete metadata.body;
    const value = run.next().value;
    expect(value).toEqual(new TextResult('The results are true.', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can handle inline expression containing equality', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpEquality';
        }),
      },
    };
    delete metadata.body;
    const value = run.next().value;
    expect(value).toEqual(new TextResult('This is a true sentence.', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can handle inline expression containing function call and expression', () => {
    ...
    const metadata = {
      ...{
        ...inlineExpressionYarnData.find((n) => {
          return n.title === 'InlineExpFunctionResultExp';
        }),
      },
    };
    delete metadata.body;
    const value = run.next().value;
    expect(value).toEqual(new TextResult('The results are 2.', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can run through a single line with an escaped curly brace', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNodeEscapeCurlyBrace';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can run through a single line with two consecutive escaped curly braces', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNodeEscapeTwoCurlyBraces';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can run through a single line with an escaped hashtag', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNodeEscapeHashtag';
        }),
      },
    };
    delete metadata.body;
  ...
  it('Can escape hashtags and comments together', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'OneNodeEscapeHashtagComment';
        }),
      },
    };
    delete metadata.body;
    const value = run.next().value;
    expect(value).toEqual(new TextResult('This is a test line#escaped//', ['lastHashtag'], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Can run through three lines when the first ends on an escaped character', () => {
    ...
    const metadata = {
      ...{
        ...linksYarnData.find((n) => {
          return n.title === 'ThreeLineEscape';
        }),
      },
    };
    delete metadata.body;
    ...
    expect(value).toEqual(new TextResult('This is another test line', [], metadata));
    value = run.next().value;
    expect(value).toEqual(new TextResult('Yet another test line', [], metadata));
    expect(run.next().done).toBe(true);
  });
  ...
  it('Throws an error if evaluateExpressionOrLiteral is called with an unknown node type', () => {
    expect(runner.evaluateExpressionOrLiteral({ type: 'TextNode', text: 'hello' })).toEqual('hello');
    expect(() => {
      runner.evaluateExpressionOrLiteral({ type: 'Blah', text: 'hello' });
    }).toThrow();
  });
  ...
  it('Throws an error if a node does not have a body', () => {
    expect(() => {
      runner.load([{ title: 'CoolNode', body: '' }]);
    }).toThrow();
  });
  ...
  it('Throws an error if custom variableStorage does not have a get or set', () => {
    expect(() => {
      runner.setVariableStorage({ set: () => {} });
    }).toThrow();
    expect(() => {
      runner.setVariableStorage({ get: () => {} });
    }).toThrow();
    expect(() => {
      runner.setVariableStorage({ get: () => {}, set: () => {} });
    }).not.toThrow();
  });
  ...
  it('handles a string yarn dialogue', () => {
    ...
    let value = run.next().value;
    expect(value).toEqual(
      new TextResult('This is a test line.', [], {
        title: 'Start',
        otherkey: 'someValue',
    ...
    value = run.next().value;
    expect(value).toEqual(
      new TextResult('This is another test line.', [], {
        title: 'End',
        filetags: ['someFiletag', 'someOtherFiletag'],
      }),
    );
  ...
  it('handles a string yarn with no tags', () => {
    ...
    const run = runner.run('Start');
    const value = run.next().value;
    expect(value).toEqual(new TextResult('This is a test line.', [], { title: 'Start' }));
    expect(run.next().done).toBe(true);
  });
